...
class AdminPageFilters
{

    public static function generateTaxonomyFilter($taxonomy_slug)
    {
        if (!$taxonomy_slug) {
    ...
    public static function customFilter($post_type, $title, $meta_key, $values)
    {
    ...
    public static function customFilterAction($query, $post_type, $meta_key, $compare)
    {
        global $pagenow;
