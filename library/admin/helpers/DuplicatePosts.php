...
class DuplicatePosts
{
    ...
    public function __construct()
    {
        ...
        add_filter('page_row_actions', array($this, 'addDuplicatePostLink'), 10, 2); // All Pages
        add_filter('post_row_actions', array($this, 'addDuplicatePostLink'), 10, 2); // All Custom Post Types
        add_action('admin_action_rd_duplicate_post_as_draft', array($this, 'duplicatePost'));
    }
